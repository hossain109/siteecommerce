...
class PageAdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('PageBundle:Administration:page/index.html.twig', array(
            'pages' => $pages,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('PageBundle:Administration:page/new.html.twig', array(
            'page' => $page,
    ...
    public function showAction(Page $page)
    {
        ...
        return $this->render('PageBundle:Administration:page/show.html.twig', array(
            'page' => $page,
    ...
    public function editAction(Request $request, Page $page)
    {
        ...
        return $this->render('PageBundle:Administration:page/edit.html.twig', array(
            'page' => $page,
